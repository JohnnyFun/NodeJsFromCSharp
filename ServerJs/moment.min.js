          ...
          e._w &&
            ...
            (function (e) {
              ...
              if (null != (t = e._w).GG || null != t.W || null != t.E)
                (r = 1), (a = 4), (n = ht(t.GG, e._a[me], Ie(Tt(), 1, 4).year)), (s = ht(t.W, 1)), ((i = ht(t.E, 1)) < 1 || 7 < i) && (u = !0)
              else {
    ...
    if (e._f !== c.ISO_8601)
      if (e._f !== c.RFC_2822) {
        ...
        for (s = j(e._f, e._locale).match(N) || [], t = 0; t < s.length; t++)
          (i = s[t]),
            (n = (l.match(le(i, e)) || [])[0]) &&
              (0 < (r = l.substr(0, l.indexOf(n))).length && g(e).unusedInput.push(r), (l = l.slice(l.indexOf(n) + n.length)), (h += n.length)),
            E[i]
              ? (n ? (g(e).empty = !1) : g(e).unusedTokens.push(i), (a = i), (u = e), null != (o = n) && m(he, a) && he[a](o, u._a, u, a))
        ...
        : ('string' == typeof r && (e._i = r = e._locale.preparse(r)),
          S(r)
            ...
            : (h(r)
                ...
                ? ((s = t),
                  null === (i = pt.exec(s._i))
                    ? (vt(s), !1 === s._isValid && (delete s._isValid, Dt(s), !1 === s._isValid && (delete s._isValid, c.createFromInputFallback(s))))
                    : (s._d = new Date(+i[1])))
                : o(n)
  ...
  function At(e, t) {
    ...
    return (
      Rt(e)
        ...
        : (a = Et.exec(e))
        ? ((n = '-' === a[1] ? -1 : 1),
          (r = { y: 0, d: k(a[ye]) * n, h: k(a[ge]) * n, m: k(a[pe]) * n, s: k(a[ve]) * n, ms: k(Ct(1e3 * a[we])) * n }))
        : (a = It.exec(e))
        ? ((n = '-' === a[1] ? -1 : 1),
          (r = { y: jt(a[2], n), M: jt(a[3], n), w: jt(a[4], n), d: jt(a[5], n), h: jt(a[6], n), m: jt(a[7], n), s: jt(a[8], n) }))
        : null == r
        ? (r = {})
        : 'object' == typeof r &&
          ('from' in r || 'to' in r) &&
  ...
  ;(ln.add = qt),
    ...
    (ln.isAfter = function (e, t) {
      ...
      return (
        ...
        ('millisecond' === (t = R(t) || 'millisecond') ? this.valueOf() > n.valueOf() : n.valueOf() < this.clone().startOf(t).valueOf())
      )
    }),
    (ln.isBefore = function (e, t) {
      ...
      return (
        !(!this.isValid() || !n.isValid()) &&
        ('millisecond' === (t = R(t) || 'millisecond') ? this.valueOf() < n.valueOf() : this.clone().endOf(t).valueOf() < n.valueOf())
      )
    }),
    ...
    (ln.startOf = function (e) {
      ...
      return (
        'week' === e && this.weekday(0), 'isoWeek' === e && this.isoWeekday(1), 'quarter' === e && this.month(3 * Math.floor(this.month() / 3)), this
      )
    }),
    (ln.subtract = Jt),
    (ln.toArray = function () {
